...
const sparkleStarsSvg = `url("data:image/svg+xml,${encodeURIComponent(`<svg xmlns='http://www.w3.org/2000/svg' width='240' height='240' viewBox='0 0 80 80'><g fill='%235B4BA0' opacity='0.06'><path d='M10 10l2 4 4 1-3 3 1 4-4-2-4 2 1-4-3-3 4-1z'/><path d='M55 8l1 3 3 0-2 2 1 3-3-1-3 1 1-3-2-2 3 0z'/><path d='M35 35l2 4 4 1-3 3 1 4-4-2-4 2 1-4-3-3 4-1z'/><path d='M70 40l1 3 3 0-2 2 1 3-3-1-3 1 1-3-2-2 3 0z'/><path d='M15 60l1 3 3 0-2 2 1 3-3-1-3 1 1-3-2-2 3 0z'/><path d='M60 68l2 4 4 1-3 3 1 4-4-2-4 2 1-4-3-3 4-1z'/></g></svg>`)}")`;
